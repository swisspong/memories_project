...
const Auth = () => {
    ...
    // registered for client ID 953400754272-9i7sr1tds9hl5or6lubhpjps6nb9kn5p.apps.googleusercontent.com. 
        ...
        <Container component='main' maxWidth="xs">
            <Paper className={classes.paper} elevation={3}>
                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <GoogleLogin
                        clientId="953400754272-9i7sr1tds9hl5or6lubhpjps6nb9kn5p.apps.googleusercontent.com"
                        render={(renderProps) => (
